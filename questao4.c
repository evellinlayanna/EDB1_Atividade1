...
// a soma dos elementos da diagonal principal e exiba o resultado. Utilize funcoes.
...
int main() {
  ...
  // tamanho A variavel soma_diagonal recebe o valor da soma dos elementos da diagonal
