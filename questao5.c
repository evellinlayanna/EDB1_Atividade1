...
// Escreva um programa em C que declare duas variaveis inteiras, utilize ponteiros para
// modificar os valores dessas variaveis e exiba os valores antes e depois da modificacao.
