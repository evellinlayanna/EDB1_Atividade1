...
//   // scanf é uma função que lê um valor do teclado e armazena na variável
//   // numeros[i]
//   printf("Insira 5 numeros inteiros:\n");
//   for (int i = 0; i < 5; i++) {
//     scanf("%d", &numeros[i]);
//   }
//   // Chama a funcao soma_vetor e passa o vetor numeros e seu tamanho 5 para
//   // somar os 5 elementos
